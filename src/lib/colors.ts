...
export const SCHEMES: ColorScheme[] = [
  // ── Bright Yellow (default) ──────────────
  {
    ...
    swatch: '#f5c518',
    light: {
      primary: '#705d00',           onPrimary: '#ffffff',
      primaryContainer: '#ffe25b',  onPrimaryContainer: '#231b00',
      secondary: '#675e3f',         onSecondary: '#ffffff',
      secondaryContainer: '#efe2bb', onSecondaryContainer: '#201c04',
      tertiary: '#43664d',          onTertiary: '#ffffff',
      tertiaryContainer: '#c4eccc',  onTertiaryContainer: '#00210f',
      surface: '#fffaf0',           onSurface: '#1e1b13',
      surfaceVariant: '#eae1cb',    onSurfaceVariant: '#4b4634',
      surfaceContainerLow: '#faf4e5',
      surfaceContainer: '#f4eedf',
      surfaceContainerHigh: '#eee8d8',
      surfaceContainerHighest: '#e8e2d2',
      outline: '#7c765f',           outlineVariant: '#cdc5ad',
    },
    dark: {
      primary: '#ebc714',           onPrimary: '#393000',
      primaryContainer: '#544600',  onPrimaryContainer: '#ffe25b',
      secondary: '#d3c6a1',         onSecondary: '#363015',
      secondaryContainer: '#4e462a', onSecondaryContainer: '#efe2bb',
      tertiary: '#a9d0b1',          onTertiary: '#133725',
      tertiaryContainer: '#2b4e3a',  onTertiaryContainer: '#c4eccc',
      surface: '#15130b',           onSurface: '#e8e2d2',
      surfaceVariant: '#4b4634',    onSurfaceVariant: '#cdc5ad',
      surfaceContainerLow: '#100e07',
      surfaceContainer: '#1d1b13',
      surfaceContainerHigh: '#28251c',
      surfaceContainerHighest: '#332f26',
      outline: '#96906c',           outlineVariant: '#4b4634',
    },
  },
