...
export const SCHEMES: ColorScheme[] = [
  // ── Warm Orange (default) ──────────────
  {
    ...
    swatch: '#ed6c02',
    light: {
      primary: '#7f3300',           onPrimary: '#ffffff',
      primaryContainer: '#ffdcc8',  onPrimaryContainer: '#2b0c00',
      secondary: '#765a48',         onSecondary: '#ffffff',
      secondaryContainer: '#ffdcc8', onSecondaryContainer: '#2b0c00',
      tertiary: '#5f6335',          onTertiary: '#ffffff',
      tertiaryContainer: '#e5e8b7',  onTertiaryContainer: '#1b1e00',
      surface: '#fff8f6',           onSurface: '#201a17',
      surfaceVariant: '#f4ded5',    onSurfaceVariant: '#52443c',
      surfaceContainerLow: '#faf3ef',
      surfaceContainer: '#f4ede9',
      surfaceContainerHigh: '#eee7e3',
      surfaceContainerHighest: '#e8e1dd',
      outline: '#85746a',           outlineVariant: '#d8c2b6',
    },
    dark: {
      primary: '#ffb692',           onPrimary: '#451600',
      primaryContainer: '#622400',  onPrimaryContainer: '#ffdcc8',
      secondary: '#e7bfaa',         onSecondary: '#442b1d',
      secondaryContainer: '#5c4132', onSecondaryContainer: '#ffdcc8',
      tertiary: '#c9cc9c',          onTertiary: '#31340b',
      tertiaryContainer: '#474b20',  onTertiaryContainer: '#e5e8b7',
      surface: '#191410',           onSurface: '#eee0d9',
      surfaceVariant: '#52443c',    onSurfaceVariant: '#d8c2b6',
      surfaceContainerLow: '#14100b',
      surfaceContainer: '#211d18',
      surfaceContainerHigh: '#2b2722',
      surfaceContainerHighest: '#36312c',
      outline: '#a38c82',           outlineVariant: '#52443c',
    },
  },
